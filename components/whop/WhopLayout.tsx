...
const WhopLayout: React.FC<WhopLayoutProps> = ({ children, activeView, onViewChange }) => {
  return (
    <div className="min-h-screen bg-zilla-black text-white">
      ...
      <header className="sticky top-0 z-50 bg-zilla-black/90 backdrop-blur-xl border-b border-zilla-neon/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link href="/whop" className="flex items-center gap-3 group">
      ...
      {/* Navigation tabs */}
      <nav className="sticky top-16 z-40 bg-zilla-black/80 backdrop-blur-lg border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
