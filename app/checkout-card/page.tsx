...
const PLAN_ID = 'plan_tHM041pqMiSBC'
...
const TRUST = ['Säker betalning', 'Vi går live inom 72h', 'Faktura via e-post']
  ...
  return (
    <div className="rounded-2xl border border-morsdag-rose/25 bg-morsdag-ink/40 p-8 sm:p-10 text-center">
      ...
      <h2 className="mt-4 font-display text-2xl sm:text-3xl text-morsdag-ivory leading-tight tracking-[-0.01em]">
        Tack — vi sätter igång nu.
      </h2>
      <p className="mt-4 text-[14px] sm:text-[15px] text-white/70 leading-relaxed max-w-md mx-auto">
        Du får ett mail med kvitto och nästa steg inom några minuter. Vi
        kontaktar dig idag för en kort kickoff och är live inom 72 timmar.
      </p>
      <Link
        href="/morsdag"
...
function CheckoutContent() {
  ...
  useEffect(() => {
    if (isSuccess) {
      trackPurchase({ value: 20000, currency: 'SEK', variant: 'card' })
    } else {
      trackInitiateCheckout({ value: 20000, currency: 'SEK', variant: 'card' })
    }
  }, [isSuccess])
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-5 lg:pt-2">
              <PriceBlock
                eyebrow="Morsdag Launch · Kort"
                priceMain="20 000 kr"
                priceSub="Setup · Engångsavgift · SEK"
                ...
                <div className="rounded-2xl border border-white/[0.08] bg-zilla-surface/60 overflow-hidden">
                  ...
                  <div className="min-h-[520px]">
                    <WhopCheckoutEmbed
                      planId={PLAN_ID}
                      theme="dark"
                      returnUrl="https://growzilla.xyz/checkout-card?success=true"
                    />
                  </div>
                </div>
              )}
