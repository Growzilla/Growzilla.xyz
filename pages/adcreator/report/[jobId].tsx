...
import ShareWidget from '@/components/adcreator/ShareWidget'
    ...
    <>
      ...
      >
        ...
        <div className="max-w-[1100px] mx-auto px-4 pt-8 space-y-12">
          ...
          {/* 4.5 Share widget — drives virality above dual CTA */}
          {!pdfMode && (
            <ShareWidget jobId={jobId} brandName={data.brand.name} />
          )}
